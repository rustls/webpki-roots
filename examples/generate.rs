...
const ANSSI_SUBJECT_DN: &[&[u8]] = &[
    b"\x31\x0B\x30\x09\x06\x03\x55\x04\x06\x13\x02",
    b"FR",
    b"\x31\x0F\x30\x0D\x06\x03\x55\x04\x08\x13\x06",
    b"France",
    b"\x31\x0E\x30\x0C\x06\x03\x55\x04\x07\x13\x05",
    b"Paris",
    b"\x31\x10\x30\x0E\x06\x03\x55\x04\x0A\x13\x07",
    b"PM/SGDN",
    b"\x31\x0E\x30\x0C\x06\x03\x55\x04\x0B\x13\x05",
    b"DCSSI",
    b"\x31\x0E\x30\x0C\x06\x03\x55\x04\x03\x13\x05",
    b"IGC/A",
    b"\x31\x23\x30\x21\x06\x09\x2A\x86\x48\x86\xF7\x0D\x01\x09\x01",
    b"\x16\x14",
    b"igca@sgdn.pm.gouv.fr",
];

const ANSSI_NAME_CONSTRAINTS: &[&[u8]] = &[
    b"\xa0\x5f",
    b"\x30\x5D\xA0\x5B",
    b"\x30\x05\x82\x03",
    b".fr",
